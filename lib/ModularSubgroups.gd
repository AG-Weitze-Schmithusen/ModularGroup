...
DeclareAttribute("LeftCosetRepresentatives", IsModularSubgroup);
...
DeclareAttribute("WordGeneratorsOfGroup", IsModularSubgroup);
...
DeclareOperation("ModularSubgroupSTViaRightAction", [IsPerm, IsPerm]);
DeclareOperation("ModularSubgroupSTViaLeftAction", [IsPerm, IsPerm]);
DeclareOperation("ModularSubgroupRT", [IsPerm, IsPerm]);
DeclareOperation("ModularSubgroupRTViaRightAction", [IsPerm, IsPerm]);
DeclareOperation("ModularSubgroupRTViaLeftAction", [IsPerm, IsPerm]);
DeclareOperation("ModularSubgroupSJ", [IsPerm, IsPerm]);
DeclareOperation("ModularSubgroupSJViaRightAction", [IsPerm, IsPerm]);
DeclareOperation("ModularSubgroupSJViaLeftAction", [IsPerm, IsPerm]);
...
DeclareOperation("SRightAction", [IsModularSubgroup]);
DeclareOperation("TRightAction", [IsModularSubgroup]);
DeclareOperation("RRightAction", [IsModularSubgroup]);
DeclareOperation("JRightAction", [IsModularSubgroup]);
DeclareOperation("SLeftAction", [IsModularSubgroup]);
DeclareOperation("TLeftAction", [IsModularSubgroup]);
DeclareOperation("RLeftAction", [IsModularSubgroup]);
DeclareOperation("JLeftAction", [IsModularSubgroup]);
...
DeclareOperation("IsWordElementOf", [IsElementOfFpGroup, IsModularSubgroup]);
DeclareOperation("IsWordElementOf", [IsString, IsModularSubgroup]);
